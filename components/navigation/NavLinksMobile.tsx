...
import mobileNavigationData from "../data/navigation";
    ...
    <>
      ...
      >
        <div
          ...
          className="w-[calc(100vmin-48px)] bg-grey-fb dark:bg-secondary absolute right-0 top-0 isolate"
        >
          <div className="flex flex-col items-end">
            <button
              className={`
                bg-grey-fb dark:bg-secondary
