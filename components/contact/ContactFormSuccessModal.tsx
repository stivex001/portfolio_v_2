    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <article className="p-6 bg-grey-fb dark:bg-primary/30 dark:md:bg-primary ring-grey-d dark:ring-grey-2 ring-1 w-full flex flex-col relative isolate">
            ...
            <div className="contact-form-success-desktop-graphic h-full justify-center items-end hidden md:flex dark:bg-secondary">
              <PlaneGraphicLarge />
            </div>
          </a.div>
        </div>
