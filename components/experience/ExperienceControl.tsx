...
import { ExperienceControlProps } from "./props";
...
export const ExperienceControl = ({
  ...
  const expertiseTabTriggerRefs = expertiseData.map(() =>
  ...
  const handleKeyDown = (event: React.KeyboardEvent<HTMLUListElement>) => {
    ...
    if (event.key === "ArrowLeft") {
      newExpertiseIndex =
        (expertiseIndex + (expertiseCount - 1)) % expertiseCount;
                ...
                <button
                  ...
                  className={`w-[12px] aspect-square rounded-[50%] ring-grey-b dark:ring-grey-5 ${
                    isActiveButton
                      ...
                      : "bg-grey-9 dark:bg-grey-4 hover:ring-1"
                  }`}
